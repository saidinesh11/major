...
# This part is image labels setting start 
        ...
        #title section
        title_lb1 = Label(bg_img,text="Help Support",font=("montserrat",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1366,height=60)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\Dell\Desktop\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\web.png")
        ...
        det_img_btn=Image.open(r"C:\Users\Dell\Desktop\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\fb.png")
        ...
        att_img_btn=Image.open(r"C:\Users\Dell\Desktop\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\yt.png")
        ...
        hlp_img_btn=Image.open(r"C:\Users\Dell\Desktop\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\gmail.png")
    ...
    def youtube(self):
        self.new = 1
        self.url = "https://www.youtube.com/channel/UCRFDoqLngnxio6dXERM5uxQ"
        webbrowser.open(self.url,new=self.new)
