...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Face Recognition Pannel",font=("montserrat",30,"bold"),bg="white",fg="navyblue")
        ...
        std_b1_1 = Button(bg_img,command=self.face_recog,text="Face Detector",cursor="hand2",font=("montserrat",15,"bold"),bg="white",fg="navyblue")
