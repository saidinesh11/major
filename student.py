...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","CSE","IT","ECE","MECH","CIVIL")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","B.Tech","MBA","M.Tech")
        cou_combo.current(0)
        ...
        #Teacher Name
        student_tutor_label = Label(class_Student_frame,text="Faculty:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #create table 
        self.student_table = ttk.Treeview(table_frame,column=("Student_ID","Name","Department","Course","Year","Semester","Division","Gender","DOB","Mobile_No","Address","Roll_No","Email","Teacher_Name","PhotoSample"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.student_table.heading("Mobile_No",text="Mob-No")
...
# ==================Function Decleration==============================
    ...
    def fetch_data(self):
        ...
        mycursor.execute("select * from student_2")
